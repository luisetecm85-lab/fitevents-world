    ...
    <div style={{position:"relative",height:"100vh",minHeight:520,display:"flex",flexDirection:"column",overflow:"hidden"}}>
      ...
      <div style={{position:"relative",zIndex:2,flex:1,display:"flex",alignItems:"center",padding:"0 6vw",marginTop:"-120px"}}>
        <div style={{maxWidth:560}}>
          <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:12}}><img src="/logo.png" alt="FitEvents World" style={{height:120,width:"auto"}}/><span style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:38,letterSpacing:3,color:"#F5F5F5"}}>FITEVENTS <span style={{color:"#FF6B00"}}>WORLD</span></span></div><div style={{display:"inline-flex",alignItems:"center",gap:6,background:"rgba(255,107,0,0.12)",border:"1px solid rgba(255,107,0,0.3)",padding:"4px 14px",borderRadius:20,fontSize:11,fontWeight:700,color:"#FF6500",letterSpacing:1,textTransform:"uppercase",marginBottom:16}}><span style={{width:6,height:6,borderRadius:"50%",background:"#FF6500",display:"inline-block"}}/>El directorio del fitness competitivo</div><div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:"clamp(60px,8vw,90px)",lineHeight:0.88,letterSpacing:4,textTransform:"uppercase",marginBottom:20,color:"#F5F5F5"}}>
