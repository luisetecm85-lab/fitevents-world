...
const EVENTS=[
  ...
  {id:17,name:"The Battle Games X",disc:"CrossFit",city:"Almassora",prov:"Castellon",country:"España",date:"2026-04-24",price:120,fmts:["Individual","Parejas","Trios","Cuartetos"],desc:"Decima edicion del Battle Games en Castellon.",feat:true,verified:false,ratings:[]},
  ...
  {id:19,name:"February Challenge Leon",disc:"CrossFit",city:"Leon",prov:"Leon",country:"España",date:"2026-01-30",price:300,fmts:["Trios","Equipos +4"],desc:"El reto de febrero en Leon.",feat:true,verified:false,ratings:[]},
  {id:20,name:"Vera Summer Showdown",disc:"CrossFit",city:"Vera",prov:"Almeria",country:"España",date:"2026-05-23",price:75,fmts:["Individual"],desc:"Throwdown en Vera, Almeria.",feat:false,verified:false,ratings:[]},
  ...
  {id:35,name:"Elite Magma Games 2026",disc:"CrossFit",city:"Malaga",prov:"Malaga",country:"España",date:"2026-02-07",price:55,fmts:["Parejas"],desc:"Evento elite de parejas en Malaga.",feat:true,verified:false,ratings:[]},
  ...
  {id:37,name:"Coin Fitness Games 2026",disc:"CrossFit",city:"Malaga",prov:"Malaga",country:"España",date:"2026-02-14",price:75,fmts:["Individual","Parejas"],desc:"Games en la provincia de Malaga.",feat:false,verified:false,ratings:[]},
  ...
  {id:42,name:"Gijon Throwdown 2025",disc:"CrossFit",city:"Gijon",prov:"Asturias",country:"España",date:"2025-11-22",price:300,fmts:["Cuartetos"],desc:"Uno de los grandes del norte de España.",feat:true,verified:false,ratings:[]},
  {id:43,name:"Castellon Throwdown 2025",disc:"CrossFit",city:"Grau de Castellon",prov:"Castellon",country:"España",date:"2025-11-15",price:120,fmts:["Individual","Parejas"],desc:"Referente en la Comunitat Valenciana.",feat:true,verified:false,ratings:[]},
  ...
  {id:45,name:"Hispania Championships 2025",disc:"CrossFit",city:"Almodovar del Rio",prov:"Cordoba",country:"España",date:"2025-11-08",price:100,fmts:["Parejas"],desc:"Campeonato Hispania en Cordoba.",feat:true,verified:false,ratings:[]},
  {id:46,name:"La Rioja Arena Games 2025",disc:"CrossFit",city:"Logrono",prov:"La Rioja",country:"España",date:"2025-10-18",price:200,fmts:["Individual","Cuartetos","Equipos +4"],desc:"Games en el Arena de Logrono.",feat:true,verified:false,ratings:[]},
  ...
  {id:48,name:"Antequera Throwdown 2025",disc:"CrossFit",city:"Antequera",prov:"Malaga",country:"España",date:"2025-10-17",price:153,fmts:["Parejas"],desc:"Throwdown en Antequera, Malaga.",feat:true,verified:false,ratings:[]},
  ...
  {id:59,name:"Gigia Games 2025",disc:"CrossFit",city:"Gijon",prov:"Asturias",country:"España",date:"2025-10-24",price:150,fmts:["Equipos +4"],desc:"Games en Gijon con equipos de 5.",feat:true,verified:false,ratings:[]},
  ...
  {id:64,name:"La Batalla de Guisando 2025",disc:"CrossFit",city:"El Tiemblo",prov:"Avila",country:"España",date:"2025-05-23",price:260,fmts:["Cuartetos"],desc:"Batalla de Guisando en Avila.",feat:true,verified:false,ratings:[]},
  ...
  {id:66,name:"Malaga Throwdown 2025",disc:"CrossFit",city:"Torremolinos",prov:"Malaga",country:"España",date:"2025-11-21",price:225,fmts:["Individual"],desc:"El gran Throwdown de Malaga.",feat:true,verified:false,ratings:[]},
  ...
  {id:107,name:"Fitness Race",disc:"Functional",city:"San Martin de la Vega",prov:"Madrid",country:"España",date:"2026-04-11",price:40,fmts:["Parejas"],desc:"Fitness Race en San Martin de la Vega, Madrid.",feat:false,verified:false,ratings:[]},
  ...
  {id:109,name:"2 Aniversario PRIME",disc:"CrossFit",city:"Alcorcon",prov:"Madrid",country:"España",date:"2026-04-11",price:25,fmts:["Parejas"],desc:"2o Aniversario Prime en Alcorcon, Madrid.",feat:false,verified:false,ratings:[]},
  ...
  {id:111,name:"Unbroken Hybrid Games",disc:"Functional",city:"Les Franqueses del Valles",prov:"Barcelona",country:"España",date:"2026-04-11",price:90,fmts:["Parejas"],desc:"Unbroken Hybrid Games en Les Franqueses del Valles, Barcelona.",feat:true,verified:false,ratings:[]},
  ...
  {id:113,name:"REPBYREP II EDITION",disc:"Functional",city:"Sabadell",prov:"Barcelona",country:"España",date:"2026-04-25",price:100,fmts:["Parejas"],desc:"RepByRep II Edition en Sabadell, Barcelona.",feat:true,verified:false,ratings:[]},
  {id:114,name:"ATENEA HYBRID RACE",disc:"Functional",city:"Girona",prov:"Girona",country:"España",date:"2026-04-18",price:120,fmts:["Parejas"],desc:"Atenea Hybrid Race en Girona.",feat:true,verified:false,ratings:[]},
  ...
  {id:116,name:"JUMANJI THROWDOWN 2",disc:"CrossFit",city:"Roquetas de Mar",prov:"Almeria",country:"España",date:"2026-04-17",price:150,fmts:["Individual","Parejas","Trios"],desc:"Jumanji Throwdown 2 en Roquetas de Mar, Almeria.",feat:true,verified:false,ratings:[]},
  {id:117,name:"Hybrid Race Evolution 4 Edicion",disc:"Functional",city:"Ibi",prov:"Alicante",country:"España",date:"2026-04-25",price:50,fmts:["Individual","Parejas"],desc:"Hybrid Race Evolution 4a Edicion en Ibi, Alicante.",feat:true,verified:false,ratings:[]},
  {id:118,name:"OWL JAM VI",disc:"CrossFit",city:"Mostoles",prov:"Madrid",country:"España",date:"2026-04-25",price:255,fmts:["Trios"],desc:"OWL JAM VI en Mostoles, Madrid.",feat:true,verified:false,ratings:[]},
  {id:119,name:"NorthFit Hybrid HK Eibar",disc:"Functional",city:"Eibar",prov:"Guipuzcoa",country:"España",date:"2026-04-25",price:150,fmts:["Parejas","Trios"],desc:"NorthFit Hybrid HK en Eibar, Guipuzcoa.",feat:true,verified:false,ratings:[]},
  ...
  {id:123,name:"Vera Summer Showdown Equipos",disc:"CrossFit",city:"Vera",prov:"Almeria",country:"España",date:"2026-05-23",price:150,fmts:["Parejas"],desc:"Vera Summer Showdown edicion equipos en Vera, Almeria.",feat:false,verified:false,ratings:[]},
  {id:124,name:"Ronda Battle Series XXVI",disc:"CrossFit",city:"Ronda",prov:"Malaga",country:"España",date:"2026-06-19",price:246,fmts:["Trios"],desc:"Ronda Battle Series XXVI en Ronda, Malaga.",feat:true,verified:false,ratings:[]},
  ...
  {id:126,name:"GIGIA GAMES 2026",disc:"CrossFit",city:"Gijon",prov:"Asturias",country:"España",date:"2026-05-15",price:180,fmts:["Cuartetos"],desc:"Gigia Games 2026 en Gijon, Asturias.",feat:true,verified:false,ratings:[]},
  {id:127,name:"II EDICION ALCAZABA THROWDOWN",disc:"CrossFit",city:"Casares",prov:"Malaga",country:"España",date:"2026-05-02",price:90,fmts:["Parejas"],desc:"Alcazaba Throwdown 2a edicion en Casares, Malaga.",feat:true,verified:false,ratings:[]},
  {id:128,name:"NIWALA NIGHT EXPERIENCE",disc:"Functional",city:"Alicante",prov:"Alicante",country:"España",date:"2026-05-30",price:67,fmts:["Parejas"],desc:"Niwala Night Experience en Alicante.",feat:false,verified:false,ratings:[]},
  {id:129,name:"ELITE FUNCTIONAL CHALLENGER TORROX 2026",disc:"Functional",city:"Torrox",prov:"Malaga",country:"España",date:"2026-04-30",price:200,fmts:["Individual"],desc:"Elite Functional Challenger en Torrox, Malaga.",feat:true,verified:false,ratings:[]},
  {id:130,name:"Desafio Marae 2026",disc:"Functional",city:"La Herradura",prov:"Granada",country:"España",date:"2026-05-23",price:150,fmts:["Parejas"],desc:"Desafio Marae 2026 en La Herradura, Granada.",feat:true,verified:false,ratings:[]},
  ...
  {id:132,name:"Rota Championship II",disc:"CrossFit",city:"Rota",prov:"Cadiz",country:"España",date:"2026-06-27",price:90,fmts:["Parejas"],desc:"Rota Championship II en Rota, Cadiz.",feat:true,verified:false,ratings:[]},
  ...
  {id:134,name:"CROSSHYBRID THROWDOWN PAMPLONA",disc:"Functional",city:"Orkoien",prov:"Navarra",country:"España",date:"2026-05-30",price:90,fmts:["Parejas"],desc:"Crosshybrid Throwdown en Orkoien, Navarra.",feat:true,verified:false,ratings:[]},
  ...
  {id:137,name:"Estepona Games",disc:"CrossFit",city:"Estepona",prov:"Malaga",country:"España",date:"2026-06-26",price:160,fmts:["Parejas"],desc:"Estepona Games en Estepona, Malaga.",feat:true,verified:false,ratings:[]},
  ...
  {id:140,name:"Mudland Games Villafranca 2026",disc:"Functional",city:"Villafranca de los Barros",prov:"Badajoz",country:"España",date:"2026-05-23",price:120,fmts:["Parejas"],desc:"Mudland Games en Villafranca de los Barros, Badajoz.",feat:true,verified:false,ratings:[]},
  {id:141,name:"Hybrid Arena Membrilla 2026",disc:"Functional",city:"Membrilla",prov:"Ciudad Real",country:"España",date:"2026-05-31",price:60,fmts:["Individual","Parejas"],desc:"Hybrid Arena Membrilla 2026 en Ciudad Real.",feat:true,verified:false,ratings:[]},
  {id:142,name:"Sacaba Summer Games 2026",disc:"CrossFit",city:"Malaga",prov:"Malaga",country:"España",date:"2026-06-06",price:185,fmts:["Parejas"],desc:"Sacaba Summer Games 2026 en Malaga.",feat:true,verified:false,ratings:[]},
  {id:143,name:"DAURADA GAMES + HYBRID RACE 2026",disc:"Functional",city:"Tarragona",prov:"Tarragona",country:"España",date:"2026-06-27",price:240,fmts:["Parejas","Cuartetos"],desc:"Daurada Games + Hybrid Race 2026.",feat:true,verified:false,ratings:[]},
  ...
  {id:166,name:"BSNT Hybrid",disc:"Functional",city:"Torrelavega",prov:"Cantabria",country:"España",date:"2026-06-13",price:65,fmts:["Parejas"],desc:"BSNT Hybrid en Torrelavega, Cantabria.",feat:false,verified:false,ratings:[]},
  ...
  {id:183,name:"ANTEQUERA THROWDOWN 2026",disc:"CrossFit",city:"Antequera",prov:"Malaga",country:"España",date:"2026-10-24",price:171,fmts:["Individual","Parejas"],desc:"Antequera Throwdown 2026 en Antequera, Malaga.",feat:true,verified:false,ratings:[]},
  ...
  {id:187,name:"WOD GAMES LA CARLOTA 2026",disc:"CrossFit",city:"La Carlota",prov:"Cordoba",country:"España",date:"2026-11-14",price:100,fmts:["Parejas"],desc:"Wod Games La Carlota 2026 en Cordoba.",feat:true,verified:false,ratings:[]},
  ...
  {id:203,name:"The Battle Games 2025",disc:"CrossFit",city:"Castellon",prov:"Castellon",country:"España",date:"2025-04-04",price:193,fmts:["Individual","Parejas","Trios"],desc:"The Battle Games 25 en Castellon.",feat:true,verified:false,ratings:[]},
  ...
  {id:207,name:"OWL JAM 5",disc:"CrossFit",city:"Mostoles",prov:"Madrid",country:"España",date:"2025-04-05",price:90,fmts:["Trios"],desc:"OWL JAM 5 en Mostoles, Madrid.",feat:true,verified:false,ratings:[]},
  ...
  {id:212,name:"Desafio Marae 2025",disc:"Functional",city:"La Herradura",prov:"Granada",country:"España",date:"2025-05-24",price:140,fmts:["Parejas"],desc:"Desafio Marae 2025 en La Herradura, Granada.",feat:true,verified:false,ratings:[]},
  ...
  {id:216,name:"Vera Summer Showdown 2025",disc:"CrossFit",city:"Vera",prov:"Almeria",country:"España",date:"2025-05-31",price:130,fmts:["Parejas"],desc:"Vera Summer Showdown 2025 en Vera, Almeria.",feat:false,verified:false,ratings:[]},
  {id:217,name:"SACABA SUMMER GAMES 2025",disc:"CrossFit",city:"Malaga",prov:"Malaga",country:"España",date:"2025-05-31",price:190,fmts:["Parejas"],desc:"Sacaba Summer Games 2025 en Malaga.",feat:true,verified:false,ratings:[]},
  ...
  {id:223,name:"Hyperion Athletics",disc:"Functional",city:"Las Rozas",prov:"Madrid",country:"España",date:"2025-06-07",price:70,fmts:["Parejas"],desc:"Hyperion Athletics en Las Rozas, Madrid.",feat:false,verified:false,ratings:[]},
  ...
  {id:229,name:"Trocadero Games",disc:"CrossFit",city:"Cadiz",prov:"Cadiz",country:"España",date:"2025-09-13",price:90,fmts:["Parejas"],desc:"Trocadero Games en Cadiz.",feat:true,verified:false,ratings:[]},
  ...
  {id:232,name:"BRAVE CHALLENGE 2025",disc:"Functional",city:"Blanes",prov:"Girona",country:"España",date:"2025-09-20",price:55,fmts:["Parejas"],desc:"Brave Challenge 2025 en Blanes, Girona.",feat:true,verified:false,ratings:[]},
  ...
  {id:234,name:"NorthFit Hybrid Donostia",disc:"Functional",city:"Donostia",prov:"Guipuzcoa",country:"España",date:"2025-10-18",price:88,fmts:["Individual","Parejas"],desc:"NorthFit Hybrid en Donostia, Guipuzcoa.",feat:true,verified:false,ratings:[]},
  {id:235,name:"Vitality Games 2025",disc:"CrossFit",city:"Mostoles",prov:"Madrid",country:"España",date:"2025-10-25",price:95,fmts:["Parejas"],desc:"Vitality Games 2025 en Mostoles, Madrid.",feat:false,verified:false,ratings:[]},
  ...
  {id:238,name:"Gijón Throwdown 2025",disc:"CrossFit",city:"Gijon",prov:"Asturias",country:"España",date:"2025-11-22",price:380,fmts:["Cuartetos"],desc:"Gijon Throwdown 2025 en Gijon, Asturias.",feat:true,verified:false,ratings:[]},
  {id:239,name:"REPbyREP 2025",disc:"Functional",city:"Sabadell",prov:"Barcelona",country:"España",date:"2025-11-22",price:80,fmts:["Parejas"],desc:"RepByRep 2025 en Sabadell, Barcelona.",feat:false,verified:false,ratings:[]},
...
export default function App(){const isMobile=useIsMobile();
  ...
  return<div style={{minHeight:"100vh",background:"#0a0a0a",display:"flex",flexDirection:"column"}}>
    ...
    <div style={{display:"flex",flex:1}}>
      ...
      {(view==="legal-privacy"||view==="legal-terms"||view==="legal-cookies"||view==="legal-aviso")&&<div style={{maxWidth:720,margin:"0 auto"}}>
  ...
  {view==="legal-privacy"&&<div><div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:28,fontWeight:900,marginBottom:16,textTransform:"uppercase",color:"#FF6500"}}>Política de Privacidad</div><p style={{color:"#888",fontSize:12,marginBottom:16}}>Responsable del tratamiento: Luis [Apellidos] · contacto@fiteventsworld.com</p><p style={{color:"#bbb",fontSize:13,lineHeight:1.7,marginBottom:12}}>FitEvents World recoge únicamente los datos necesarios para el funcionamiento de la plataforma: email y nombre visible al registrarte, y datos de actividad (valoraciones y eventos marcados como "Quiero ir").</p><p style={{color:"#bbb",fontSize:13,lineHeight:1.7,marginBottom:12}}>No cedemos tus datos a terceros ni los usamos para publicidad personalizada. El tratamiento se basa en tu consentimiento (art. 6.1.a RGPD). Puedes ejercer tus derechos de acceso, rectificación, supresión y portabilidad escribiendo a contacto@fiteventsworld.com.</p><p style={{color:"#bbb",fontSize:13,lineHeight:1.7,marginBottom:12}}>Los datos se almacenan en Firebase (Google LLC). Puedes reclamar ante la AEPD (aepd.es).</p></div>}
